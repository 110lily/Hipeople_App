...
import com.myungwoo.datingappkotlinproject.firebase.FBAuth
import com.myungwoo.datingappkotlinproject.firebase.FBRef
import com.myungwoo.datingappkotlinproject.data.UserInfoData
import com.myungwoo.datingappkotlinproject.databinding.ActivityNickNameBinding
...
class NickNameActivity : AppCompatActivity() {
    ...
    private fun userPictureUpload(uid: String) {
        ...
        binding.imageView2.isDrawingCacheEnabled = true // 캐시를 사용할지 말지 여부 결정
        binding.imageView2.buildDrawingCache() //  drawing cache에 저장하는 함수
